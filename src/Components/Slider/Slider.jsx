    ...
    return (
        ...
        >
            <SwiperSlide className='lg:mt-0 mt-16'>
                    ...
                    <div className="text-white relative text-center brightness-40 rounded-xl bg-no-repeat bg-[url(/src/assets/Images/Art_Gallery.png)] lg:mb-[50px] lg:ml-[110px] w-[400px] h-[500px] lg:p-0 p-2 ml-3 lg:w-[1320px] lg:h-[600px] md:w-[745px] flex items-center justify-center ">
            ...
            <SwiperSlide className='lg:mt-0 mt-16'>
                ...
                <div className="text-center rounded-xl bg-no-repeat bg-[url(/src/assets/Images/CC.png)] lg:mb-[50px] lg:ml-[110px] lg:w-[1320px] lg:h-[600px] w-[400px] h-[500px] md:w-[745px] lg:p-0 p-2 ml-3 flex items-center justify-center">
...
<div>
    ...
    <p data-aos="fade-right" data-aos-duration="3000" className='mb-10 text-[#FFF] text-lg font-normal'>Our flexible event spaces and modern amenities cater to a wide range of events, from trade shows and conventions to concerts and community gatherings.</p>
            ...
            <SwiperSlide className='lg:mt-0 mt-16'><div className="text-center rounded-xl bg-no-repeat bg-[url(/src/assets/Images/H.png)] lg:mb-[50px] lg:ml-[110px] lg:w-[1320px] md:w-[745px] lg:h-[600px] w-[400px] h-[500px] lg:p-0 p-5 ml-3 flex items-center justify-center">
            <div>
            ...
            <SwiperSlide className='lg:mt-0 mt-16'><div className="text-center rounded-xl bg-no-repeat bg-[url(/src/assets/Images/CR.png)] mb-[50px] lg:mb-[50px] lg:ml-[110px] md:w-[745px] lg:w-[1320px] lg:h-[600px] w-[400px] h-[500px] lg:p-0 p-2 ml-3 flex items-center justify-center">
            <div>
            ...
            <SwiperSlide className='lg:mt-0 mt-16'><div className="text-center rounded-xl bg-no-repeat bg-[url(/src/assets/Images/Temple.png)] lg:mb-[50px] lg:ml-[110px] md:w-[745px] lg:w-[1320px] lg:h-[600px] w-[400px] h-[500px] lg:p-0 p-2 ml-3 flex items-center justify-center">
            <div>
            ...
            <SwiperSlide className='lg:mt-0 mt-16'><div className="text-center rounded-xl bg-no-repeat bg-[url(/src/assets/Images/T.png)] lg:mb-[50px] lg:ml-[110px] md:w-[745px] lg:w-[1320px] lg:h-[600px] w-[400px] h-[500px] lg:p-0 p-2 ml-3 flex items-center justify-center">
            <div>
